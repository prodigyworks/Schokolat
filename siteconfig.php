...
<form id="contentForm" name="contentForm" method="post" class="entryform">
	...
	<label>Refresh Cycle (Seconds)</label>
	<input required="true" type="text" id="refreshcycle" name="refreshcycle" value="<?php echo $member['refreshcycle']; ?>" />
	...
	<input type="hidden" id="refereereportemail" name="refereereportemail" value="<?php echo $member['refereereportemail']; ?>" />
	<input type="hidden" id="address" name="address" value="<?php echo $member['address']; ?>" />
